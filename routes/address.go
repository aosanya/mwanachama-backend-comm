...
// models.AddressRepository with the caller's own id from [Identity] and no
...
func AddressRoutes(addr models.AddressRepository, identity Identity) []Route {
	return []Route{
...
func ListMyAddresses(addr models.AddressRepository, identity Identity) http.HandlerFunc {
...
func RetireAddress(addr models.AddressRepository, identity Identity) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
